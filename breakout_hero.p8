...
function explodebrick(_i)
  ...
  for j=1,#bricks do
    if j!=_i and bricks[j].v and abs(bricks[j].x-bricks[_i].x)<=(brick_w+2)and abs(bricks[j].y-bricks[_i].y)<=(brick_h+2) then
...
function draw_winner()
  ...
  if loghs then
    ...
    print("★congratulations!★",25,_y+4,1)
    ...
    print("ok",68,_y+34,_colors[4])
 
    print("use ⬅️➡️⬆️⬇️ and ❎",26,_y+44,6)
  else
    ...
    print("for the high score list.",15,_y+26,7)
    print("try again!",45,_y+32,7)

    print("press ❎ to exit menu",22,_y+44,blink_b)
  end
end
...
function draw_start()
  ...
  --draw logo
  palt(14,true)
  spr(64,(hs_x-128)+35,10,7,5)
  palt()

  print("music by grubermusic",24+(hs_x-128),60,2)
  print("patreon.com/gruber99",24+(hs_x-128),66,2)
  ...
  if hs_x>=0 then    
    ...
    print("press ❎ to start",30,95,blink_g)
    print("press ⬆️⬇️ to toggle fast mode",5,115,3)
  
    if hs_x==128 then    
      print("press ⬅️ to see high score",13,107,3)
    elseif hs_x==0 then
      print("press ➡️ to back main menu",13,107,3)
    end
  end
end
...
function draw_gameover()
  ...
  rectfill(0,52,128,82,0)
  print("game over",46,57,7)
  ...
  print("press ❎ or ➡️ to retry level",6,66,_c1)
  print("press 🅾️ or ⬅️ to exit menu",10,73,_c2)
end

function draw_levelover()
  draw_game()

  rectfill(0,55,128,80,12)
  print("stage clear!",41,60,1)
  print("press ❎ or ➡️ to continue",12,71,blink_b)
end
...
function draw_game()
  ...
  for i=1,#ball do
    ...
    if b.stuck then
      ...
      pset(b.x+b.dx*4*arrm,b.y+b.dy*4*arrm,10)
      pset(b.x+b.dx*4*arrm2,b.y+b.dy*4*arrm2,10) 
    end
  end
  ...
  if debug!="" then
    ...
    spr(15,1,1)
    print(":"..lives,7,1,7)
    print("score:"..pointstring(points2,points),25,1,7)

    if levelnum<=15 then
      print("lvl:"..levelnum,85,1,7)
    end
...
function ballintercept(_b,_box,_nx,_ny)
  ...
  if _ny<_b.y then
    _pt=intercept(_b.x,_b.y,_nx,_ny,_box.left-ball_r,_box.bottom+ball_r,_box.right+ball_r,_box.bottom+ball_r,"bottom")
  elseif _ny>_b.y then
    _pt=intercept(_b.x,_b.y,_nx,_ny,_box.left-ball_r,_box.top-ball_r,_box.right+ball_r,_box.top-ball_r,"top")
  end

  if _pt==nil then
    if _nx<_b.x then
      _pt=intercept(_b.x,_b.y,_nx,_ny,_box.right+ball_r,_box.top-ball_r,_box.right+ball_r,_box.bottom+ball_r,"right")
    elseif _nx>_b.x then
      _pt=intercept(_b.x,_b.y,_nx,_ny,_box.left-ball_r,_box.top-ball_r,_box.left-ball_r,_box.bottom+ball_r,"left")
    end
  end 
    ...
    for i=1,#bricks do
      ...
      if bricks[i].v then
        ...
        if _tmpcol~=nil then
          ...
          if ((timer_mega>0 or timer_mega_w>0) and bricks[i].t=="i") or (timer_mega<=0 and timer_mega_w<=0) then     
            add(_cols,_tmpcol)
          else
            add(_mcols,_tmpcol)
          end
...
function padramcheck(_b)
  ...
  if box_box(_pbox.left+1,_pbox.top+1,pad_w-2,pad_w,_b.x-ball_r,_b.y-ball_r,ball_r*2,ball_r*2) then
    if _b.dy<0 then
      -- ball flying up.
      return
    end
...
__gfx__

...

__label__
